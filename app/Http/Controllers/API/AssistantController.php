...
class AssistantController extends Controller
{
    public function editProfile ( Request $request )
    {
        ...
        { 
            $status = Account::assistantEditProfile ( \Auth::user() -> id, trim($_POST["name"]), trim($_POST["department"]), 
                        trim($_POST["grade"]), trim($_POST["talent"]), trim($_POST["subject"]), trim($_POST['ability']), isset($_FILES['img']) && $_FILES['img']['size'] ? $_FILES['img'] : NULL );
